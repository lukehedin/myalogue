			...
			<div className="panel-standard">
				<div className="container">
					<div className="row">
						...
						<p className="page-subtitle">A list of each achievement along with the percent of users who have unlocked it. 
						{/* NOAUTH: hide prompt to create account */}
						{/* {Util.context.isAuthenticated() ? <span>For your own achievements, <Link to={Util.route.withQueryParams(Util.route.profile(Util.context.getUserId()), { tabId: 'achievements' })}>visit your profile</Link>.</span> : <span>To start unlocking achievements, <Link to={Util.route.register()}>create an account</Link>.</span>} */}
						</p>
