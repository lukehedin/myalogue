			...
			<div className="panel-standard">
				<div className="container">
					<div className="row">
						...
						<p className="center">If you have questions, suggestions or problems with <b>Speak<span className="pink">4</span>Yourself</b>, you can send an email to <a rel="noopener noreferrer" href="mailto:admin@s4ycomic.com">admin@s4ycomic.com</a>.</p>
